...
import (
	...
	"github.com/imanabr77/URL-Shortener/database"
	"github.com/imanabr77/URL-Shortener/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
	...
	if err == redis.Nil {
		...
		v, _ = r2.Get(database.Ctx, c.IP()).Result()
	...
	v, _ = r.Get(database.Ctx, id).Result()
	if v != "" {
	...
	v, _ = r2.Get(database.Ctx, c.IP()).Result()
	resp.XRateRemaining, _ = strconv.Atoi(v)
